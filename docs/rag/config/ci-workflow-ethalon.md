...
|---------|-------|-------------------|
| `selenoid-qa-guru_github.yml` | app e2e на Pages + cloud hub | tms-automator, one-page-form |
...
|----------|---------|----------------------|
| App e2e | `selenoid-qa-guru_github.yml` | `…/templates/tests-java/.github/workflows/selenoid-qa-guru_github.yml` |
| App e2e | | `…/one-page-form-tests-java/.github/workflows/selenoid-qa-guru_github.yml` |
